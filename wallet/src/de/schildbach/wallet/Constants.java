...
public final class Constants {
    ...
    public static final String SOURCE_URL = "https://github.com/xazab/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
    public static final String BINARY_URL = "https://github.com/xazab/" + CoinDefinition.coinName.toLowerCase() + "-wallet/releases";
